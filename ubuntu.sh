...
export 'PATH="/home/wilder/my-scripts":$PATH' >> /home/wilder/.bashrc
...
distribution=$(. /etc/os-release;echo $ID$VERSION_ID) \
    ...
    && curl -s -L https://nvidia.github.io/nvidia-docker/$distribution/nvidia-docker.list | sudo t    ee /etc/apt/sources.list.d/nvidia-docker.list
